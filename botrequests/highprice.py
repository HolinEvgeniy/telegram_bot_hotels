...
def high_price_sort_hotels(user_city: str, user_count_hotels: int) -> Union[int, list[dict]]:
    """
    Функция вывода отсортированных отелей от самого дорого до самого дешевого
